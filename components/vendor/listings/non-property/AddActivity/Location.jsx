    ...
    <div className="row y-gap-10 x-gap-10">
      ...
      {isThirdParty ? (
        <div className="col-sm-6 mt-5">
          <h1 className="text-14 lh-12 fw-500">Enter Location Address</h1>
          <input
