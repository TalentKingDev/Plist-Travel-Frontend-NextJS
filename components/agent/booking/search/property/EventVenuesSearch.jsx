...
const index = () => {
  ...
  return (
    <div className="py-20 px-20 rounded-8 bg-white shadow-3">
      <h1 className="text-30 lh-14 fw-600">Event Venues Search</h1>
      <div className="text-15 text-light-1">
        Find the perfect event venue for your client
      </div>
      <div className="row x-gap-10 y-gap-10 mt-10">
        <div className="col-sm-4 mt-5">
          ...
          <div className="position-relative d-flex items-center mt-10">
            <input
              ...
              className="border-light bg-white rounded-8 h-45 px-10 py-5 pl-30"
            />
            <span
        ...
        <div className="col-12 mt-10">
          <button className="bg-blue-1 text-white rounded-8 py-10 px-20 w-100 fw-500 text-14">
            <i className="icon icon-search"></i> Search Event Venues
          </button>
        </div>
      </div>
    </div>
