    ...
    <div className="row y-gap-10 x-gap-10">
      ...
      <div className="col-sm-6 mt-5">
        ...
        <input
          className="border-light rounded-8 py-5 px-15 w-full mt-10"
          type="text"
          placeholder="i.e. Visit historic landmarks, museums, and parks"
        />
      </div>

      <div className="col-sm-6 mt-5">
        <h1 className="text-14 lh-12 fw-500">Inclusions/Exclusions</h1>
        <input
          className="border-light rounded-8 py-5 px-15 w-full mt-10"
          type="text"
          placeholder="i.e. Included: Guide, Entrance fees; Excluded: Meals, Transportation"
        />
      </div>
      ...
      <div className="col-sm-6 mt-5">
        <h1 className="text-14 lh-12 fw-500">Guide Info</h1>
        <input
          className="border-light rounded-8 py-5 px-15 w-full mt-10"
          type="text"
          placeholder="Guide: Sarah Johnson, Experienced historian"
        />
      </div>
